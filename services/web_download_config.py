...
class WebDownloadingConfig(BaseDownloadingConfig):
    def __init__(
        self, choosen_items: str, yt_dlp_format: str, os_name: str, username: str
    ) -> None:
    ...
    def choose_item(self, ydl_options: dict):
    ...
    def get_options(self) -> dict:
        ...
        self.choose_format(ydl_options)
        self.choose_item(ydl_options)
        return ydl_options
